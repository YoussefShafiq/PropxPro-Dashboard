...
export default function WebinarsVideosDataTable({ WebinarsVideosData, loading, refetch }) {
    ...
    const handleConfirmDelete = async () => {
        ...
        try {
            await axios.delete(
                `https://api.propxpro.com/api/admin/webinars/videos/${videoToDelete}`,
                {
                    headers: {
                        Authorization: `Bearer ${localStorage.getItem('userToken')}`
                    }
    ...
    const handleAddVideo = async (e) => {
        ...
        try {
            await axios.post(
                'https://api.propxpro.com/api/admin/webinars/videos',
                formDataToSend,
                {
                    headers: {
                        'Authorization': `Bearer ${localStorage.getItem('userToken')}`,
    ...
    const handleUpdateVideo = async (e) => {
        ...
        try {
            await axios.post(
                `https://api.propxpro.com/api/admin/webinars/videos/${selectedVideo.slug}`,
                formDataToSend,
                {
                    headers: {
                        'Authorization': `Bearer ${localStorage.getItem('userToken')}`,
