...
export default function IntegrationsDataTable({ integrations, loading, refetch }) {
    ...
    const handleToggleStatus = async (integrationId) => {
        ...
        try {
            await axios.patch(
                `http://3.19.62.232/api/admin/integrations/${integrationId}/toggle-status`,
                {},
                {
                    headers: {
    ...
    const handleConfirmDelete = async () => {
        ...
        try {
            await axios.delete(
                `http://3.19.62.232/api/admin/integrations/${integrationToDelete}`,
                {
                    headers: {
                        Authorization: `Bearer ${localStorage.getItem('userToken')}`
                    }
    ...
    const handleAddIntegration = async (e) => {
        ...
        try {
            ...
            await axios.post(
                'http://3.19.62.232/api/admin/integrations',
                formDataToSend,
                {
                    headers: {
                        'Authorization': `Bearer ${localStorage.getItem('userToken')}`,
    ...
    const handleEditIntegration = async (e) => {
        ...
        try {
            ...
            await axios.post(
                `http://3.19.62.232/api/admin/integrations/${selectedIntegration.id}`,
                formDataToSend,
                {
                    headers: {
                        'Authorization': `Bearer ${localStorage.getItem('userToken')}`,
