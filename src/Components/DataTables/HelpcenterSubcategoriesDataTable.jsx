...
export default function HelpcenterSubcategoriesDataTable({
    ...
    const createMutation = useMutation({
        mutationFn: (newSubcategory) => {
            return axios.post(
                'https://api.propxpro.com/api/admin/help-center/subcategories',
                newSubcategory,
                {
                    headers: {
                        Authorization: `Bearer ${localStorage.getItem('userToken')}`
    ...
    const updateMutation = useMutation({
        mutationFn: (updatedSubcategory) => {
            return axios.put(
                `https://api.propxpro.com/api/admin/help-center/subcategories/${updatedSubcategory.id}`,
                updatedSubcategory,
                {
                    headers: {
                        Authorization: `Bearer ${localStorage.getItem('userToken')}`
    ...
    const deleteMutation = useMutation({
        mutationFn: (id) => {
            return axios.delete(
                `https://api.propxpro.com/api/admin/help-center/subcategories/${id}`,
                {
                    headers: {
                        Authorization: `Bearer ${localStorage.getItem('userToken')}`
                    }
    ...
    const handleToggleStatus = async (subcategoryId, currentStatus) => {
        ...
        try {
            await axios.patch(
                `https://api.propxpro.com/api/admin/help-center/subcategories/${subcategoryId}/toggle-status`,
                {},
                {
                    headers: {
                        Authorization: `Bearer ${localStorage.getItem('userToken')}`
